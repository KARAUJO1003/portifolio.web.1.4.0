...
export const TitleTypography = ({
  ...
  return (
    <h2
      {...props}
      className={cn(
        `${sizeXl || size2Xl || size4Xl || size8Xl} ${fontWeight} cursor-default text-opacity-100 from-zinc-50 capitalize to-zinc-500 bg-gradient-to-b bg-clip-text text-transparent`,
        className
      )}
    >
      {children}
