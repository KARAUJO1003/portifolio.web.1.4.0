  ...
  return (
    ...
    >
      ...
      <div className="space-y-5 flex items-start  justify-between gap-5 w-full">
        <div className="flex flex-col max-w-96 gap-5 mt-5">
          <TitleTypography
            size="text-4xl"
          ...
          <div className="relative inline-flex  overflow-hidden rounded-md p-[1px] focus:outline-none focus:ring-1 focus:ring-zinc-400/20 focus:ring-offset-1 focus:ring-offset-zinc-50/20 w-min">
            ...
            <span
              className={cn(
                [
                  'bg-zinc-950 hover:bg-zinc-950/70 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-md transition-all duration-200 px-6 py-2 text-xs uppercase font-medium text-muted-foreground hover:text-zinc-50 backdrop-blur-3xl',
                ],
                className,
              )}
            >
